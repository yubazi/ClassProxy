...
import com.bug.dexmaker.dx.rop.annotation.AnnotationVisibility;
import com.bug.dexmaker.dx.rop.annotation.Annotations;
    ...
    public void addToMethod(DexMaker dexMaker, MethodId<?, ?> method) {
        ...
        if (classDefItem == null) {
            ...
            if (cstMethodRef == null) {
                ...
                classDefItem.addMethodAnnotations(cstMethodRef, annotations);
            }
        }
    }
