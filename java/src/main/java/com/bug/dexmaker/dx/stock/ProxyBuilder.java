...
package com.bug.dexmaker.dx.stock;
...
public final class ProxyBuilder<T> {
    ...
    public Class<? extends T> buildProxyClass() throws IOException {
        ...
        if (sharedClassLoader) {
            classLoader = dexMaker.generateAndLoad(null, dexCache, true);
        } else {
            classLoader = dexMaker.generateAndLoad(parentClassLoader, dexCache, true);
        }
        try {
